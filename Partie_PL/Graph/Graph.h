...
public :
   ...
   float weight; //Demand of the node
   float x,y;
...
public:
  ...
  int truck_capacity; //Capacity of the trucks
  int nb_max_trucks;
  ...
  // Read a complete undirected "cvrp" format file
  // and store the corresponding graph in C_Graph
	void read_undirected_complete_CVRP(istream & fic);
